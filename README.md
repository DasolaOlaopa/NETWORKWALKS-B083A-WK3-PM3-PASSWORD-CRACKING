...
John the Ripper (JTR) is a widely used password cracking tool for testing password strength across Unix, Windows, and Mac systems. It supports many hash types and can recover passwords from protected files like PDFs, ZIPs, and Office documents. Johnny is the graphical front-end for JTR, making it accessible without needing to run commands manually.
